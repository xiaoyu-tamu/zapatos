...
export type IsolationSatisfying<T extends IsolationLevel> = {
  ...
  [IsolationLevel.RepeatableRead]:
    | IsolationSatisfying<IsolationLevel.Serializable>
    | IsolationLevel.RepeatableRead;
  [IsolationLevel.ReadCommitted]:
    | IsolationSatisfying<IsolationLevel.RepeatableRead>
    | IsolationLevel.ReadCommitted;
  [IsolationLevel.SerializableRO]:
    | IsolationSatisfying<IsolationLevel.Serializable>
    | IsolationLevel.SerializableRO;
  ...
  [IsolationLevel.ReadCommittedRO]:
    ...
    | IsolationLevel.ReadCommittedRO;
  [IsolationLevel.SerializableRODeferrable]:
    | IsolationSatisfying<IsolationLevel.SerializableRO>
    | IsolationLevel.SerializableRODeferrable;
}[T];
...
export type TxnClientForRepeatableRead = TxnClient<
  IsolationSatisfying<IsolationLevel.RepeatableRead>
>;
export type TxnClientForReadCommitted = TxnClient<
  IsolationSatisfying<IsolationLevel.ReadCommitted>
>;
export type TxnClientForSerializableRO = TxnClient<
  IsolationSatisfying<IsolationLevel.SerializableRO>
>;
export type TxnClientForRepeatableReadRO = TxnClient<
  IsolationSatisfying<IsolationLevel.RepeatableReadRO>
>;
export type TxnClientForReadCommittedRO = TxnClient<
  IsolationSatisfying<IsolationLevel.ReadCommittedRO>
>;
export type TxnClientForSerializableRODeferrable = TxnClient<
  IsolationSatisfying<IsolationLevel.SerializableRODeferrable>
>;
        ...
        if (
          ...
          if (attempt < maxAttempts) {
            ...
            if (transactionListener) {
              transactionListener(
                `Transaction rollback (code ${err.code}) on attempt ${attempt} of ${maxAttempts}, retrying in ${delayBeforeRetry}ms`,
                txnId
              );
            }
            ...
            if (transactionListener) {
              transactionListener(
                `Transaction rollback (code ${err.code}) on attempt ${attempt} of ${maxAttempts}, giving up`,
                txnId
              );
            }
            throw err;
...
export async function serializable<T>(
  txnClientOrPool: pg.Pool | TxnClientForSerializable,
...
export async function repeatableRead<T>(
  txnClientOrPool: pg.Pool | TxnClientForRepeatableRead,
...
export async function readCommitted<T>(
  txnClientOrPool: pg.Pool | TxnClientForReadCommitted,
...
export async function serializableRO<T>(
  txnClientOrPool: pg.Pool | TxnClientForSerializableRO,
...
export async function repeatableReadRO<T>(
  txnClientOrPool: pg.Pool | TxnClientForRepeatableReadRO,
...
export async function readCommittedRO<T>(
  txnClientOrPool: pg.Pool | TxnClientForReadCommittedRO,
...
export async function serializableRODeferrable<T>(
  txnClientOrPool: pg.Pool | TxnClientForSerializableRODeferrable,
